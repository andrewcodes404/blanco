...
class Backend
{
        ...
        if ($this->should_load_js() && !$this->is_wizard_page()) {
            ...
            wp_enqueue_script(
                ...
                WP_SHOPIFY_PLUGIN_URL .
                    'admin/js/vendor/jquery.validate.min.js',
                ['jquery'],
                filemtime(
                    WP_SHOPIFY_PLUGIN_DIR_PATH .
                        'admin/js/vendor/jquery.validate.min.js'
            ...
            $runtime_url = WP_SHOPIFY_PLUGIN_URL . 'dist/runtime.c7832b.min.js';
            $vendors_admin_url =
                WP_SHOPIFY_PLUGIN_URL . 'dist/vendors-admin.c7832b.min.js';
            $main_url = WP_SHOPIFY_PLUGIN_URL . 'dist/admin.c7832b.min.js';
    ...
    public function add_dashboard_menus()
    {
        if (current_user_can('manage_options')) {
            ...
            // add_submenu_page('wpshopify', __('Add-ons', 'wpshopify'), __('Add-ons', 'wpshopify'), 'manage_options', 'wps-addons', [$this, 'plugin_admin_page']);
            ...
            add_submenu_page(
                ...
                'wpshopify-wizard',
                function () {
                    echo '<div id="wpshopify-wizard">Wizard</div>';
                }
            );
        }
    }
    ...
    public function add_action_links($links)
    {
        ...
        $settings_link[] =
            '<a href="' .
            esc_url('https://wpshop.io/purchase') .
            '" target="_blank">' .
    ...
    public function wpshopify_blocks_assets()
    {
        if (is_admin()) {
            ...
            $vendors_admin_url =
                WP_SHOPIFY_PLUGIN_URL . 'dist/vendors-admin.c7832b.min.js';
            $main_url = WP_SHOPIFY_PLUGIN_URL . 'dist/blocks.c7832b.min.js';
    ...
    public function wpshopify_wizard_assets()
    {
        if ($this->is_wizard_page()) {
            ...
            $vendors_admin_url =
                WP_SHOPIFY_PLUGIN_URL . 'dist/vendors-admin.c7832b.min.js';
            $main_url = WP_SHOPIFY_PLUGIN_URL . 'dist/wizard.c7832b.min.js';
    ...
    public function wpshopify_wizard_redirect()
    {
        ...
        if (isset($_GET['wpshopify-finished-wizard'])) {
        ...
        if ($this->is_wizard_page() && $this->is_wizard_completed()) {
            wp_safe_redirect(
                esc_url(admin_url('/admin.php?page=wps-settings'))
            );
            exit();
