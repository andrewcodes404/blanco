...
class Transients
{
	...
	*/
    ...
    public static function delete_all_custom_options()
    {
        ...
        $plugin_options = $wpdb->get_results(
            "SELECT option_name FROM $wpdb->options WHERE option_name LIKE 'wp_shopify_%' OR option_name LIKE 'wps_settings_%' OR option_name LIKE '%_transient_wp_shopify_%' OR option_name LIKE 'wps_admin_%'"
        );
	...
	*/
    public static function delete_custom_options()
    {
        ...
        $results[
            'wp_shopify_custom_options'
        ] = self::delete_all_custom_options();
	...
	*/
    public static function delete_cached_prices()
    {
        ...
        $results = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` LIKE '%_transient_wps_product_price_id_%'"
        );
	...
	*/
    public static function delete_long_term_cache()
    {
        ...
        $query =
            "DELETE FROM " .
            $wpdb->options .
            " WHERE `option_name` LIKE '%wp_shopify_%' OR `option_name` LIKE '%wpshopify_%' AND `option_name` NOT LIKE '%wp_shopify_cache_cleared%'";
	...
	*/
    public static function delete_cached_variants()
    {
        ...
        $results = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` LIKE '%_transient_wps_product_with_variants_%'"
        );
	...
	*/
    public static function delete_cached_settings()
    {
        ...
        $results = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` LIKE '%_transient_wps_settings_%' OR `option_name` LIKE '%_transient_wps_table_single_row_%'"
        );
	...
	*/
    public static function delete_cached_product_queries()
    {
        ...
        $results = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` LIKE '%_transient_wp_shopify_products_query_hash_cache_%'"
        );
	...
	*/
    public static function delete_cached_product_single()
    {
        ...
        $results = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` LIKE '%_transient_wps_product_single_%'"
        );
	...
	*/
    public static function delete_cached_single_collections()
    {
        ...
        $results = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` LIKE '%_transient_wps_collection_single_%'"
        );
	...
	*/
    public static function delete_cached_single_collection_by_id($postID)
    {
        ...
        $results = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` = '_transient_wps_collection_single_" .
                $postID .
                "'"
        );
	...
	*/
    public static function delete_cached_single_product_by_id($postID)
    {
        ...
        $resultsSingle = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` = '_transient_wps_product_single_" .
                $postID .
                "'"
        );
        $resultsImages = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` = '_transient_wps_product_single_images_" .
                $postID .
                "'"
        );
        $resultsTags = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` = '_transient_wps_product_single_tags_" .
                $postID .
                "'"
        );
        $resultsVariants = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` = '_transient_wps_product_single_variants_" .
                $postID .
                "'"
        );
        $resultsOptions = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` = '_transient_wps_product_single_options_" .
                $postID .
                "'"
        );
        $resultsProductData = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` = '_transient_wps_product_data_" .
                $postID .
                "'"
        );

        // TODO: Add error + message handling for these two operations
        $resultsAllVariants = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` = '_transient_wps_product_single_all_variants_" .
                $postID .
                "'"
        );

        $resultsInStockVariants = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` = '_transient_wps_product_single_variants_in_stock_" .
                $postID .
                "'"
        );
	...
	*/
    public static function delete_cached_collection_queries()
    {
        ...
        $results = $wpdb->query(
            "DELETE FROM " .
                $wpdb->options .
                " WHERE `option_name` LIKE '%_transient_wps_collections_query_hash_cache_%'"
        );
