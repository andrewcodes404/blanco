...
class Defaults
{
    ...
    public function search_component_attributes($attrs)
    {
        return [
            ...
            'dropzone_form' => apply_filters(
                'wps_search_dropzone_form',
                $this->Render_Attributes->attr($attrs, 'dropzone_form', false)
            ),
            ...
            'pagination' => apply_filters(
                ...
                $this->Render_Attributes->attr($attrs, 'pagination', false)
            ),
            'pagination_page_size' => apply_filters(
                'wps_search_pagination_page_size',
                $this->Render_Attributes->attr(
                    $attrs,
            ...
            'pagination_load_more' => apply_filters(
                'wps_search_pagination_load_more',
                $this->Render_Attributes->attr(
                    $attrs,
            ...
            'pagination_hide_initial' => apply_filters(
                'wps_search_pagination_hide_initial',
                $this->Render_Attributes->attr(
                    $attrs,
            ...
            'show_pagination' => apply_filters(
                ...
                $this->Render_Attributes->attr($attrs, 'show_pagination', false)
            ),
    ...
    public function search_query_attributes($attrs)
    {
        ...
        return [
            'query' => apply_filters(
                'wps_search_query',
                $this->Render_Attributes->attr($attrs, 'query', '*')
            ),
            'sort_by' => apply_filters(
                'wps_search_sort_by',
                $this->Render_Attributes->attr($attrs, 'sort_by', $search_by)
            ),
            ...
            'page_size' => apply_filters(
                ...
                $this->Render_Attributes->attr($attrs, 'page_size', $page_size)
            ),
        ];
    }
    ...
    public function search($attrs)
    {
        $all_atts = $this->Render_Attributes->standardize_layout_data(
            $this->all_search_attributes($attrs)
        );
