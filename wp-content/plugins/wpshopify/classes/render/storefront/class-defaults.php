...
class Defaults
{
        ...
        return [
            'query' => apply_filters(
                ...
                $this->Render_Attributes->attr(
                    $attrs,
                    'query',
                    $this->Products_Defaults->create_product_query($attrs)
                )
            ),
    ...
    {
        return [
            'show_tags' => apply_filters(
                'wps_storefront_show_tags',
                $this->Render_Attributes->attr($attrs, 'show_tags', true)
            ),
            'show_vendors' => apply_filters(
                'wps_storefront_show_vendors',
                $this->Render_Attributes->attr($attrs, 'show_vendors', true)
            ),
            'show_types' => apply_filters(
                'wps_storefront_show_types',
                $this->Render_Attributes->attr($attrs, 'show_types', true)
            ),
            'show_selections' => apply_filters(
                'wps_storefront_show_selections',
                $this->Render_Attributes->attr($attrs, 'show_selections', true)
            ),
            'show_sorting' => apply_filters(
                'wps_storefront_show_sorting',
                $this->Render_Attributes->attr($attrs, 'show_sorting', true)
            ),
            'show_pagination' => apply_filters(
                'wps_storefront_show_pagination',
                $this->Render_Attributes->attr($attrs, 'show_pagination', true)
            ),
            'show_options_heading' => apply_filters(
    ...
    public function storefront_component_attributes($attrs)
    {
        return [
            'render_from_server' => apply_filters(
                'wps_storefront_render_from_server',
                $this->Render_Attributes->attr(
                    $attrs,
                    'render_from_server',
                    false
            ...
            'dropzone_payload' => apply_filters(
            ...
            'dropzone_options' => apply_filters(
            ...
            'dropzone_selections' => apply_filters(
            ...
            'dropzone_sorting' => apply_filters(
                'wps_storefront_dropzone_sorting',
                $this->Render_Attributes->attr($attrs, 'dropzone_sorting', true)
            ),
            'dropzone_heading' => apply_filters(
            ...
            'dropzone_loader' => apply_filters(
                'wps_storefront_dropzone_loader',
                $this->Render_Attributes->attr($attrs, 'dropzone_loader', false)
            ),
            'dropzone_notices' => apply_filters(
                'wps_storefront_dropzone_notices',
                $this->Render_Attributes->attr(
                    $attrs,
                    'dropzone_notices',
                    false
            ...
            'pagination_page_size' => apply_filters(
                'wps_storefront_pagination_page_size',
                $this->Render_Attributes->attr(
                    $attrs,
            ...
            'pagination_load_more' => apply_filters(
                'wps_storefront_pagination_load_more',
                $this->Render_Attributes->attr(
                    $attrs,
            ...
            'skip_initial_render' => apply_filters(
                'wps_storefront_skip_initial_render',
                $this->Render_Attributes->attr(
                    $attrs,
                    'skip_initial_render',
                    false
    ...
    {
        $all_atts = $this->Render_Attributes->standardize_layout_data(
