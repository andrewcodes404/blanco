...
class Tags extends \WP_Shopify\DB
{
    ...
    {
        $this->table_name_suffix = WP_SHOPIFY_TABLE_NAME_TAGS;
    ...
    {
        return ['id', 'tag_id', 'product_id', 'post_id'];
    }
	...
	*/
    public function get_tags_from_post_id($postID = null)
    {
        ...
        $query =
            ...
            $wpdb->prefix .
            WP_SHOPIFY_TABLE_NAME_TAGS .
            ' as tags ON products.product_id = tags.product_id WHERE products.post_id = %d';
	...
	*/
    public function get_unique_tags()
    {
        ...
        return array_values(
            array_unique(array_map([__CLASS__, 'return_tag'], $tags))
        );
    }
   ...
   */
    public function get_product_ids_from_tag($tag)
    {
    ...
    public function get_product_ids_from_tags($tag)
    {
        return $this->select_in_col('product_id', 'tag', $tag);
    }
