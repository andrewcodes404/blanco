...
class Settings_License extends \WP_Shopify\DB
{
    ...
    {
        $this->table_name_suffix = WP_SHOPIFY_TABLE_NAME_SETTINGS_LICENSE;
   ...
   */
	...
	*/
    ...
    {
        if (
            Utils::str_contains($expiration_date, '1970-01-01') ||
            $expiration_date === 0 ||
